...
function processMarkdownFiles() {
    ...
    toGenerate.forEach(g => {
        // Lógica simplificada de navegação para o exemplo
        const finalHtml = htmlTemplate(g.data, g.htmlContent, '../home.html', '../home.html');
        fs.writeFileSync(g.outputPath, finalHtml, 'utf8');
    });

    console.log(`📄 Manifesto atualizado com categorias!`);
}
